        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mt-2">
                        <img id="productImagePreview" src="" alt="" style="max-width: 64px;" />
                    </div>
                    ...
                    <form method="POST"
                        ...
                        <div class=" grid grid-cols-1 gap-4 ms:grid-cols-2">
                            <div>
                                <label for="product_image" class="block text-sm font-medium text-gray-700"> Image
                                </label>
                            ...
                            <div>
                                <label for="product_name" class="block text-sm font-medium text-gray-700"> Tasks
                                </label>
                            ...
                            <div>
                                ...
                                <input type="text" id="task_description" name="task_description"
                                    value="{{ isset($product) ? $product->task_description : old('task_description') }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            </div>
